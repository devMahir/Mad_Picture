...
class HomevideoController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $allvideos = Homevideo::all();
        foreach ($allvideos as $allvideo) {
            if ($allvideo -> status == true) {
                $allvideo -> status = false;
                $allvideo -> save();
            }
        }
        $video -> status = true;
        $video -> save();
        return redirect()->route('homevideo.index')->with('successMsg', 'Home Video Change Successfully');
    }
